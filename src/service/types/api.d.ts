...
import { ArticleProps, FileStatusEnum, FollowProps, UserFileProps, UserProps } from "./db"
...
export namespace PutUserFileInfo {
    type Request = (Pick<UserFileProps, 'id'> & Partial<Omit<UserFileProps, 'id' | 'userId' | 'createTime' | 'updateTime' | 'deleteTime' | 'isDir' | 'originFileId'>>)[]
...
export namespace GetArticleDetailInfo {
    ...
    type Response = {
        ...
        data: {
            ...
            /** 用户信息 */
            userInfo: Pick<ArticleProps, 'userId'> & Pick<UserProps, 'nickname' | 'avatarLink'>
            /** 评论列表 */
            commenList: (ArticleCommentProps & Pick<UserProps, 'nickname' | 'avatarLink'>)[]
        }
    }
}
...
export namespace GetArticleList {
    type Request = Partial<Omit<ArticleProps, 'deleteTime' | 'updateTime' | 'createTime'>> & {
        isLiked?: 1 | 0
        isCollected?: 1 | 0
        limit?: number
...
export namespace GetArticleCommentList {
    ...
    type Response = {
        ...
        data: {
            /** 评论列表 */
            commentList: (ArticleCommentProps & Pick<UserProps, 'nickname' | 'avatarLink'>)[]
        }
    }
}
